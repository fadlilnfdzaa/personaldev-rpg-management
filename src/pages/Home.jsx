    ...
    <div className="space-y-8">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex space-x-3">
            ...
            <Link to="/quests" className="text-primary hover:text-primary-light">View All</Link>
          </div>
        </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/jobs" className="text-primary hover:text-primary-light">View All</Link>
        </div>
